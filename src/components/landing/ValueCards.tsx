...
export const ValueCards = () => {
  return <section className="bg-foreground text-background py-24 rounded-t-[3rem] -mt-10 relative z-40">
      <MaxWidthWrapper>
        <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 rounded-3xl">
          ...
          <Card className="bg-foreground/80 border-muted-foreground/20 h-[420px] flex flex-col justify-between group text-background">
            ...
            <Button variant="ghost" className="self-start text-background hover:text-background hover:bg-muted-foreground/20 text-sm">
              Meet Your Mentor
            </Button>
          </Card>
          ...
          <Card className="bg-background border-border h-[420px] flex flex-col justify-between group text-foreground">
            ...
            <Button variant="ghost" className="self-start text-foreground hover:bg-muted text-sm bg-muted">
              Get Scored
            </Button>
          </Card>
        </div>
